...
class AppDateUtils {
  ...
  static final DateFormat _ymdthmsFormat = DateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
  static final DateFormat _ymdhmsFormat = DateFormat("yyyy-MM-dd HH:mm:ss");
  ...
  static final DateFormat _apiDayFormat3 = DateFormat('MM月dd日HH:mm');
  static final DateFormat _apiYearDayFormat1 = DateFormat('yyyyMM');
  static final DateFormat _apiYearDayFormat2 = DateFormat('yyyy-MM-dd');
  static final DateFormat _apiYearDayFormat3 = DateFormat('yyyy-MM');
  static final DateFormat _apiTime = DateFormat('HH:mm:ss');

  static String formatYmdthms(DateTime d) => _ymdhmsFormat.format(d);
  ...
  static String apiDayFormat3(DateTime d) => _apiDayFormat3.format(d);

  static String apiYearDayFormat1(DateTime d) => _apiYearDayFormat1.format(d);

  static String apiYearDayFormat2(DateTime d) => _apiYearDayFormat2.format(d);
  static String apiYearDayFormat3(DateTime d) => _apiYearDayFormat3.format(d);

  static String apiTime(DateTime d) => _apiTime.format(d);
  ...
  /// 时间格式转换
  static String stringToYMDString(String dateTime) {
    try {
      final date = _ymdthmsFormat.parse(dateTime);
      return _apiDayFormat.format(date);
    } catch (e) {
      return dateTime;
    }
  }

  static String longToYear(int dateTime) {
    final sdf = DateFormat(Y);
    final date = DateTime.fromMillisecondsSinceEpoch(dateTime);
    return sdf.format(date);
  }

  static String? stringToStringWithPattern(String pattern, String dateTime) {
    try {
      final date = _ymdthmsFormat.parse(dateTime);
