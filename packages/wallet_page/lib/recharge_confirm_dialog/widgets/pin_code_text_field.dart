...
class PinCodeTextField extends StatefulWidget {
  ...
  const PinCodeTextField({
    ...
    this.pinTextAnimatedSwitcherDuration = Duration.zero,
    this.hasError = false,
...
class PinCodeTextFieldState extends State<PinCodeTextField>
  ...
  Widget _buildPinCode(int i, BuildContext context) {
    ...
    final highlightPinBoxColor = widget.highlightPinBoxColor;
      ...
      return Padding(
        ...
        child: AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            final pinBoxDecoration = widget.pinBoxDecoration;
            if (pinBoxDecoration != null) {
              boxDecoration = pinBoxDecoration(
                _highlightAnimationColorTween?.value ?? Colors.transparent,
                pinBoxColor,
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Container(
            decoration: widget.hasUnderline && text.length > i
                ? BoxDecoration(
                    border: Border(
                      bottom: BorderSide(
